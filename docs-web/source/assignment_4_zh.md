...
最终应用可以在浏览器中运行，并已经作为静态网页应用集成到本 Sphinx 课程网站中。
...
该应用适合本课程作业，因为它具备可运行性、领域针对性和 AI 辅助开发特征。

## 局限性

本工具仅用于教学和探索性分析，不是经过认证的航空、导航或卫星链路规划系统。

主要的数据限制在于，公开的 OpenSky 历史数据可能存在较大的覆盖缺口。因此，本工具并不声称页面中展示的完整航线是真实完整 ADS-B 轨迹，而是展示建模航线，并将 OpenSky 证据单独保留。
